...
export default function LeadAuditCTA() {
  return (
    <div className="relative rounded-2xl overflow-hidden border border-[#3B82F6]/20 bg-white">
      {/* Top accent line */}
      ...
      <div className="relative z-10 p-8 md:p-10">
        ...
        <h3 className="text-2xl md:text-3xl font-black text-[#0F0E0C] mb-3 leading-tight">
          Check Your{" "}
          <span className="text-[#3B82F6]">Digital Health Score</span>
        </h3>

        <p className="text-[#6B6560] mb-6 leading-relaxed max-w-lg">
        ...
        <ul className="space-y-3 mb-8">
          {auditItems.map(({ icon: Icon, label }) => (
            <li key={label} className="flex items-center gap-3 text-sm text-[#6B6560]">
        ...
        <p className="mt-4 text-xs text-[#6B6560] font-mono">
