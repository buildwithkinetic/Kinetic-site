...
export const metadata: Metadata = {
  title: "AI Agents & Automation Systems | Kinetic",
  description:
    "Custom AI agents that handle lead qualification, follow-up, and support autonomously. Built on n8n, integrated into your existing workflow.",
}
